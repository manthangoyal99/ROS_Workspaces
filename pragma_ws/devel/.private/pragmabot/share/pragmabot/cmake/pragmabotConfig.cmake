...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pragmabot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ravi/pragma_ws/src/pragmabot-repro/pragmabot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ravi/pragma_ws/devel/.private/pragmabot/lib;/home/ravi/pragma_ws/devel/lib;/home/ravi/fr3_ws2/devel/lib;/opt/ros/noetic/lib)
