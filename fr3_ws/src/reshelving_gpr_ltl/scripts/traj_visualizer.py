...
def main():
    ...
    source_keypoints = load_json('source_keypoints.json')
    ...
    # --- PLOT ORIENTATIONS ---
    print("Plotting frames... (Red=X, Green=Y, Blue=Z)")
    plot_orientations(ax, warp_pos, warp_ori, step=100, scale=0.05, alpha=0.3)
    plot_orientations(ax, demo_pos, demo_ori, step=100, scale=0.05, alpha=0.8)
