...
from task_automaton import ScoopPlaceAutomaton
...
class FiniteDiffRecorder:
    def __init__(self):
        ...
        self.current_propositions = [0, 0, 0] 
        rospy.Subscriber('/task/atomic_propositions', Int8MultiArray, self.cb_propositions)

        self.automaton = ScoopPlaceAutomaton()
        self.mode_labels = [] # To store the mode for every point
    ...
    def cb_propositions(self, msg):
        # Update internal variable whenever Node 1 publishes
            ...
            while not rospy.is_shutdown():
                ...
                if self.recording:
                    try:
                        ...
                        mode_id, mode_name = self.automaton.update(list(self.current_propositions))
                        # 3. Store Data
                        ...
                        self.sensor_props.append(self.current_propositions)
