...
class KeypointLoggerRGBD:
    def __init__(self):
        ...
        self.SAVE_DIR = "/home/ravi/fr3_ws/src/reshelving_gpr_ltl/data"
        ...
        self.cam_info_sub = rospy.Subscriber("/camera/color/camera_info", CameraInfo, self.info_callback)
    ...
    def save_keypoints(self, point_type):
        ...
        rospy.loginfo(f"Labeled keypoints for {point_type}:\n{labeled_keypoints}")
        data = {
            "type": point_type,
