...
class TrajectoryValidator:
    def __init__(self):
        ...
        # --- CONFIG ---
        self.data_dir = "/home/ravi/fr3_ws/src/TPGPT_two_args/data"
        self.traj_file = os.path.join(self.data_dir, "warped_trajectory_pick.json")
    ...
    def play(self):
        ...
        for i in range(len(self.data['positions'])):
            ...
            if curr_gripper_state == 1 and prev_gripper_state == 0:
                ...
                goal = GraspGoal(width=self.data['metadata'].get('object_width', 0.0), speed=0.1, force=20.0)
